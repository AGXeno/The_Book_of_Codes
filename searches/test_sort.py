...
Date: 3 Jul 2020
Purpose:
This test code **verifies** certain expected properties and behavior of students
code solution submissions
for this project, and is used to automate grading. The fact that a submission
passes all these tests
means that some properites have been verified--it does **not** mean that the code
is **TESTED**,
industrial-strength code.
This test code purposely avoids using requiring unit testing modules like pytest
and unitttest,
because built-in assertions are sufficient here.
However, this file **can** be run without modification using pytest, to take
advantage of
